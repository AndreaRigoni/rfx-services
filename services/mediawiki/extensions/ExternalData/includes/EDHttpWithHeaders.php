...
//qui errore da modsecurity var_dump($errors); exit(0);

//array(1) { [0]=> array(3) { ["type"]=> string(5) "error" ["message"]=> string(15) "http-bad-status" ["params"]=> array(2) { [0]=> string(3) "403" [1]=> string(9) "Forbidden" } } }
